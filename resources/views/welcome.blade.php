                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-gray-900 dark:text-white">Generate QR Code By Black Ice</a>
                            </div>
                        </div>
                        ...
                        {{-- <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <div class="visible-print text-center">
                                    {!! QrCode::size(100)->generate(Request::url('https://maps.app.goo.gl/fBRiVVL3Aa2mimsRA?g_st=it')) !!}
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <div class="visible-print text-center">
                                    {!! QrCode::size(300)->generate('https://maps.app.goo.gl/fBRiVVL3Aa2mimsRA?g_st=it') !!}
                                    <p>Scan me to return to the original page.</p>
                                </div>
                            </div>
                        </div>
